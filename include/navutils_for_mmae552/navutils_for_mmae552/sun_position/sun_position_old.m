function sun = sun_position_old(time, location)
% sun = sun_position_sdb(time, location)
%
...
% 1 May 2008 Modified to accept vector inputs.  S. Datta-Barua
...
denominator = cos(sun_geocentric_declination * pi/180) ...
    - (y.*sin(eq_horizontal_parallax * pi/180)) ...
    .* cos(observer_local_hour * pi/180);%***This denominator has y instead
% of x, which I believe is incorrect.
