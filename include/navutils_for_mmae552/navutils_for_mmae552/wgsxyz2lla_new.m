...
% 29 Mar 2006 Allow for n x 3 matrix of [x, y, z]. SDB.
% 13 Sept 2013 This is converting Calgary CASES xyz's weirdly (works ok for
% 1x3 array input, but not for nx3.  Use xyz2llhtest.m.

function [wlat, wlon, walt] = wgsxyz2lla_new(xyz)
