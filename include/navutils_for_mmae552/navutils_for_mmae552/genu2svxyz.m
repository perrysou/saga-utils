...
function svxyz = genu2svxyz(lat, lon, ht, gENU)
...
% Get rotation matrix.  Notice for the direction of this transform, we
% want rotate through the angle so the angle is positive. R = [3 x 3 x n].
