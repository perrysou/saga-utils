function fig_handle = pltiono(auto_mode)
...
if nargin < 1,
  ...
  fig_handle = figure('color','black', ...
     ...
     'NumberTitle','off', ...
     'Name','Ionospheric Delays', ...
     'Tag','fign');
end;

fig_title_cell={'Ionospheric Path Delay Modeling';};
x = t_pr_base;
y = iono_base;
prn = prn_base;
axis_label_cell = {''; 'Ionosphere Delay (m)';char(fig_title_cell);};
...
descriptive_text_cell = ...
 {'The Constellation Toolbox provides the ability to model atmospheric path delays'; ...
  ...
  'ionosphere delays are some the largest error sources, particularly for low';
  'elevation satellites.  Ionosphere delays with 10 deg mask are shown below.'};
