function fig_handle = pltnmdop(auto_mode)

% Example function to plot DOPs obtained from NMEA data.
...
if nargin < 1,
  ...
  fig_handle = figure('color','black', ...
   ...
   'NumberTitle','off', ...
   'Name','NMEA Data: DOP Values', ...
   'Tag','fign');
end;

fig_title_cell={'DOP Values';};

x = hours_dop;
y = [pdop hdop vdop];

axis_label_cell = {'Hours Past Start (UTC)'; 'DOP'; ...
  'DOPs Collected Using NMEA Messages';};
...
descriptive_text_cell = ...
 {'The NMEA data from a GPS receiver provides the user with a wealth of';
  ...
  'An example of this information is the Dilution of Precision (DOP) values';
  'which are output in the $GPGSA message.  In addition, this NMEA message ';
  'contains the satellite numbers being tracked and the fix quality.  This';
